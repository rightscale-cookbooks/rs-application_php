...
recipe 'rs-application_php::attach_server', 'Attaches the PHP application server' +
...
attribute 'rs-application_php/local_settings_file',
  ...
  :description => 'The name of local settings file to be generated by a template. Example: LocalSettings.php',
